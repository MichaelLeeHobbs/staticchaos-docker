...
#define L_DEI		MAX_LEVEL - 2
#define L_ANG		MAX_LEVEL - 3
#define L_HER		MAX_LEVEL - 4
#define	L_DEP		MAX_LEVEL - 5
...
const	struct	cmd_type	cmd_table	[] =
{
    ...
    { "finish",		do_finish,	POS_RESTING,	 2,  LOG_NORMAL },
    ...
    { "tell",		do_tell,	POS_SLEEPING,	 0,  LOG_PC	},
    { "tie",		do_tie,		POS_FIGHTING,	 2,  LOG_NORMAL },
    { "untie",		do_untie,	POS_FIGHTING,	 2,  LOG_NORMAL },
     ...
     * Legend commands.
     */
    { "cflag",		do_cflag,	POS_RESTING,	 2,  LOG_ALWAYS },
    { "challenge",	do_challenge,	POS_STANDING,	 2,  LOG_NORMAL },
    { "dare",		do_dare,	POS_STANDING,	 2,  LOG_NORMAL },
    { "gift",		do_gift,	POS_STANDING,	 2,  LOG_NORMAL },
    { "humiliate",	do_humiliate,	POS_RESTING,	 2,  LOG_ALWAYS },
    { "humiliation",	do_humiliation,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "legend",		do_legend,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "lenter",		do_lenter,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "lexit",		do_lexit,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "preserve",	do_preserve,	POS_STANDING,	 2,  LOG_NORMAL },
    { "reclaim",	do_reclaim,	POS_STANDING,	 2,  LOG_NORMAL },
    { "reduction",	do_reduction,	POS_STANDING,	20,  LOG_ALWAYS },
    { "retarget",	do_retarget,	POS_FIGHTING,	20,  LOG_NORMAL },

    /*
     * Suit commands.
     */
    { "fire",		do_fire,	POS_RESTING,	 2,  LOG_NORMAL },
    { "fly",		do_fly,		POS_RESTING,	 2,  LOG_NORMAL },
    { "install",	do_install,	POS_RESTING,	 2,  LOG_NORMAL },
    { "leave",		do_leave,	POS_RESTING,	 2,  LOG_NORMAL },
    { "load",		do_load,	POS_RESTING,	 2,  LOG_NORMAL },
    { "mount",		do_mount,	POS_RESTING,	 2,  LOG_NORMAL },
    { "punch",		do_punch,	POS_RESTING,	 2,  LOG_NORMAL	},
    { "ready",		do_ready,	POS_RESTING,	 2,  LOG_NORMAL },
    { "salvo",		do_salvo,	POS_RESTING,	 2,  LOG_NORMAL },
    { "shell",		do_shell,	POS_RESTING,	 2,  LOG_NORMAL },
    { "slash",		do_slash,	POS_RESTING,	 2,  LOG_NORMAL },
    { "status",		do_status,	POS_RESTING,	 2,  LOG_NORMAL },
    { "wreck",		do_wreck,	POS_STANDING,	 2,  LOG_NORMAL },
    ...
    { "board",		do_board,	POS_DEAD,	 1,  LOG_NORMAL },
    ...
    { "contracts",	do_contracts,	POS_SLEEPING,	 0,  LOG_NORMAL },
    { "credits",	do_credits,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "dice",		do_dice,	POS_RESTING,	 0,  LOG_NORMAL },
    { "equipment",	do_equipment,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "examine",	do_examine,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "fatality",	do_fatality,	POS_DEAD,    L_DEI,  LOG_NORMAL },
    ...
    { "lamerboards",	do_lamerboards,	POS_DEAD,	 0,  LOG_NORMAL },
    { "leaderboards",	do_leaderboards,POS_DEAD,	20,  LOG_NORMAL },
    { "level",		do_level,	POS_DEAD,	 0,  LOG_NORMAL },
    { "loserboards",	do_loserboards,	POS_DEAD,	20,  LOG_NORMAL },
    { "pkstat",		do_pkstat,	POS_DEAD,	 0,  LOG_NORMAL },
    { "report",		do_report,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "pagelength",     do_pagelen,     POS_DEAD,        0,  LOG_NORMAL },
    { "quest",		do_quest,	POS_STANDING,	 1,  LOG_ALWAYS },
    ...
    { "timer",		do_timer,	POS_DEAD,	 0,  LOG_NORMAL },
    { "typo",		do_typo,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "uniques",	do_uniques,	POS_SLEEPING,	 0,  LOG_NORMAL },
    { "vote",		do_vote,	POS_SLEEPING,	 1,  LOG_NORMAL },
     ...
     */
    { "answer",		do_answer,	POS_MORTAL,	 0,  LOG_PC	},
    { "auction",	do_auction,	POS_SLEEPING,	 0,  LOG_ALWAYS },
    { "chat",		do_chat,	POS_MORTAL,	 0,  LOG_PC	},
    { ".",		do_chat,	POS_MORTAL,	 0,  LOG_PC	},
    { "emote",		do_emote,	POS_RESTING,	 0,  LOG_PC	},
    { ",",		do_emote,	POS_RESTING,	 0,  LOG_PC	},
    { "gtell",		do_gtell,	POS_DEAD,	 0,  LOG_PC	},
    { ";",		do_gtell,	POS_DEAD,	 0,  LOG_NORMAL	},
    { "maccept",	do_maccept,	POS_RESTING,	 0,  LOG_NORMAL },
    { "mbanish",	do_mbanish,	POS_RESTING,	 0,  LOG_NORMAL },
    { "mjoin",		do_mjoin,	POS_STANDING,	 0,  LOG_NORMAL },
    { "mlist",		do_mlist,	POS_SLEEPING,    0,  LOG_NORMAL },
    { "mname",		do_mname,	POS_RESTING,	 0,  LOG_NORMAL },
    { "mtalk",		do_mtalk,	POS_SLEEPING,	 0,  LOG_ALWAYS },
    { "music",		do_music,	POS_MORTAL,	 0,  LOG_PC	},
    { "note",		do_note,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "pose",		do_pose,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "question",	do_question,	POS_MORTAL,	 0,  LOG_PC	},
    { "reply",		do_reply,	POS_MORTAL,	 0,  LOG_PC	},
    { "say",		do_say,		POS_RESTING,	 0,  LOG_PC	},
    { "'",		do_say,		POS_RESTING,	 0,  LOG_PC	},
    { "shout",		do_shout,	POS_MORTAL,	 3,  LOG_PC	},
    { "yell",		do_yell,	POS_MORTAL,	 0,  LOG_PC	},

    /*
     * Object manipulation commands.
     */
    { "bounty",		do_bounty,	POS_RESTING,	 0,  LOG_NORMAL },
    { "brandish",	do_brandish,	POS_RESTING,	20,  LOG_NORMAL	},
    { "claim",		do_claim,	POS_RESTING,	 2,  LOG_ALWAYS },
    ...
    { "zap",		do_zap,		POS_RESTING,	20,  LOG_NORMAL	},

    /*
     * Combat commands.
     */
    { "backstab",	do_backstab,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "bs",		do_backstab,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "clearstats",	do_clearstats,	POS_STANDING,	 0,  LOG_NORMAL },
    { "disarm",		do_disarm,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "escape",		do_escape,	POS_MORTAL,	 2,  LOG_NORMAL },
    { "flee",		do_flee,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "flex",		do_flex,	POS_RESTING,	 1,  LOG_NORMAL },
    { "group",          do_group,       POS_MORTAL,      0,  LOG_NORMAL },
    ...
    { "rub",		do_rub,		POS_RESTING,	 1,  LOG_NORMAL },
    { "sap",		do_sap,		POS_STANDING,	 2,  LOG_NORMAL },
    { "whirl",		do_whirl,	POS_RESTING,	 1,  LOG_NORMAL },

    /*
     * Clan commands
     */
    { "accept",		do_accept,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "banis",		do_banis,	POS_STANDING,	 2,  LOG_NORMAL },
    { "banish",		do_banish,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "clantalk",	do_clantalk,	POS_SLEEPING,	 1,  LOG_ALWAYS },
    { "clanrank",	do_clanrank,	POS_STANDING,	 2,  LOG_NORMAL },
    { "clanboards",	do_clanboards,	POS_DEAD,	 1,  LOG_NORMAL },
    { "clandeposit",	do_clandeposit,	POS_STANDING,	 2,  LOG_NORMAL },
    { "clanbalance",	do_clanbalance,	POS_STANDING,	 2,  LOG_NORMAL },
    { "diplomacy",	do_diplomacy,	POS_DEAD,	 1,  LOG_NORMAL },
    { "induct",		do_induct,	POS_STANDING,	 2,  LOG_ALWAYS },
    /*
     * Fist specific commands
     */
    { "bodytrain",	do_bodytrain,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "dim-mak",	do_dim_mak,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "discipline",	do_discipline,	POS_STANDING,	 2,  LOG_NORMAL },
    { "eyesight",	do_eyesight,	POS_STANDING,	 2,  LOG_NORMAL },
    { "shinkick",	do_shinkick,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "jab",		do_jab,		POS_FIGHTING,	 2,  LOG_NORMAL },
    { "innerfire",	do_innerfire,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "levitate",	do_levitate,	POS_STANDING,	 2,  LOG_NORMAL	},
    { "phoenixaura",	do_phoenixaura,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "spinkick",	do_spinkick,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "knee",		do_knee,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "elbow",		do_elbow,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "uppercut",	do_uppercut,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "combo",		do_combo,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "master",		do_master,	POS_STANDING,	 2,  LOG_NORMAL },
    { "roundhouse",	do_roundhouse,	POS_FIGHTING,	 2,  LOG_NORMAL },

    /*
     * Patryn specific commands
     */
    { "circle",		do_circle,	POS_RESTING,	 2,  LOG_NORMAL },
    ...
    { "tattoo",		do_tattoo,	POS_STANDING,	 2,  LOG_NORMAL },

    /*
     * Saiyan specific commands
     */
    { "battlesense",	do_battlesense,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "flight",		do_flight,	POS_STANDING,	 2,  LOG_NORMAL },
    { "focus",		do_focus,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "hawkeyes",	do_hawkeyes,	POS_STANDING,	 2,  LOG_NORMAL },
    { "kaiouken",	do_kaiouken,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kamehameha",	do_kamehameha,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kiblast",	do_kiblast,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kibolt", 	do_kibolt,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kibomb", 	do_kibomb,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kikouhou",	do_kikouhou,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "shunkanidou",	do_shunkanidou,	POS_STANDING,	 2,  LOG_NORMAL },
    { "kisense", 	do_kisense,	POS_STANDING,	 2,  LOG_NORMAL },
    { "kiwall",		do_kiwall,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "kiwave",		do_kiwave,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "masenkouha",	do_masenkouha,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "rage",		do_rage,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "solarflare",	do_solarflare,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "technique",	do_technique,	POS_STANDING,	 2,  LOG_NORMAL },
    { "ryuken",		do_ryuken,	POS_FIGHTING,	 2,  LOG_NORMAL },

    /* Sorcerer specific commands */
    { "chant",		do_chant,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "concentrate",	do_concentrate,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "prepare",	do_prepare,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "research",	do_research,	POS_STANDING,	 2,  LOG_NORMAL },
    { "specialize",	do_specialize,	POS_STANDING,	 2,  LOG_NORMAL },

    /* Mazoku class commands */
    { "astrike",	do_astrike,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "charge",		do_charge,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "develop",	do_develop,	POS_STANDING,	 2,  LOG_NORMAL },
    { "form",		do_form,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "gouge",		do_gouge,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "grow",		do_grow,	POS_STANDING,	 2,  LOG_NORMAL },
    { "imbue",		do_imbue,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "instantiate",	do_instantiate,	POS_STANDING,	 2,  LOG_ALWAYS },
    { "lash",		do_lash,	POS_RESTING,	 2,  LOG_NORMAL },
    { "morph",		do_morph,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "reform",		do_reform,	POS_STANDING,	 2,  LOG_NORMAL },
    { "release",	do_release,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "rake",		do_rake,	POS_FIGHTING,	 2,  LOG_NORMAL },
    { "teleport",	do_teleport,	POS_STANDING,	 2,  LOG_NORMAL },
    /*
     * Miscellaneous commands.
     */
    { "enter",		do_enter,	POS_STANDING,	 2,  LOG_NORMAL },
    { "follow",		do_follow,	POS_RESTING,	 2,  LOG_NORMAL	},
    ...
    { "spend",		do_spend,	POS_RESTING,	 0,  LOG_NORMAL },
    { "split",		do_split,	POS_RESTING,	 0,  LOG_NORMAL	},
    { "steal",		do_steal,	POS_STANDING,	20,  LOG_NORMAL	},
    { "suicide",	do_suicide,	POS_STANDING,	 0,  LOG_ALWAYS },
    { "train",		do_train,	POS_RESTING,	 0,  LOG_ALWAYS	},
    ...
    { "siteban",	do_ban,		POS_DEAD,    L_SUP,  LOG_ALWAYS	},
    { "bigbang",	do_bigbang,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "buggedmob",	do_buggedmob,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "cset",		do_cset,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    ...
    { "powerset",	do_powerset,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "extraset",	do_extraset,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "llbackup",	do_llbackup,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "llsave",		do_llsave,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "llsort",		do_llsort,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "mburst",		do_mburst,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "newlock",	do_newlock,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "reboo",		do_reboo,	POS_DEAD,    L_SUP,  LOG_NORMAL	},
    { "reboot",		do_reboot,	POS_DEAD,    L_SUP,  LOG_ALWAYS	},
    { "sblast",		do_sblast,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "sbolt",		do_sbolt,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "sbomb",		do_sbomb,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "shutdow",	do_shutdow,	POS_DEAD,    L_SUP,  LOG_NORMAL	},
    { "shutdown",	do_shutdown,	POS_DEAD,    L_SUP,  LOG_ALWAYS	},
    { "squish",		do_squish,	POS_DEAD,    L_SUP,  LOG_ALWAYS },
    { "swave",		do_swave,	POS_DEAD,    L_SUP,  LOG_NORMAL },
    { "users",		do_users,	POS_DEAD,    L_ANG,  LOG_NORMAL	},
    { "wizify", 	do_wizify,	POS_DEAD,    L_SUP,  LOG_ALWAYS	},
    { "wizlock",	do_wizlock,	POS_DEAD,    L_SUP,  LOG_ALWAYS	},
    { "withdraw",	do_withdraw,	POS_DEAD,    L_SUP,  LOG_ALWAYS },

    { "force",		do_force,	POS_DEAD,    L_DEI,  LOG_ALWAYS	},
    { "log",		do_log,		POS_DEAD,    L_DEI,  LOG_ALWAYS	},
    { "minionset",	do_minionset,	POS_DEAD,    L_DEI,  LOG_ALWAYS },
    { "mload",		do_mload,	POS_DEAD,   L_HERO,  LOG_ALWAYS	},
    { "mset",		do_mset,	POS_DEAD,    L_DEI,  LOG_ALWAYS	},
    { "noemote",	do_noemote,	POS_DEAD,    L_DEI,  LOG_NORMAL	},
    { "nonote",		do_nonote,	POS_DEAD,    L_DEI,  LOG_ALWAYS },
    { "notell",		do_notell,	POS_DEAD,    L_DEI,  LOG_NORMAL	},
    { "oload",		do_oload,	POS_DEAD,   L_HERO,  LOG_ALWAYS	},
    { "oset",		do_oset,	POS_DEAD,    L_DEI,  LOG_ALWAYS	},
    { "owhere",		do_owhere,	POS_DEAD,   L_HERO,  LOG_NORMAL	},
    ...
    { "apurge",		do_apurge,	POS_DEAD,   L_HERO,  LOG_ALWAYS },
    { "restore",	do_restore,	POS_DEAD,   L_HERO,  LOG_ALWAYS	},
    { "retir",		do_retir,	POS_DEAD,    L_DEI,  LOG_ALWAYS },
    { "retire",		do_retire,	POS_DEAD,    L_DEI,  LOG_ALWAYS },
    { "rset",		do_rset,	POS_DEAD,    L_DEI,  LOG_ALWAYS	},
    { "silence",	do_silence,	POS_DEAD,    L_DEP,  LOG_NORMAL },
    ...
    { "mpstat",         do_mpstat,      POS_DEAD,   L_HERO,  LOG_NORMAL },
    { "mplist",		do_mplist,	POS_DEAD,    L_DEI,  LOG_NORMAL },

    { "at",		do_at,		POS_DEAD,   L_HERO,  LOG_NORMAL	},
    { "bamfin",		do_bamfin,	POS_DEAD,    L_ANG,  LOG_NORMAL	},
    { "bamfout",	do_bamfout,	POS_DEAD,    L_ANG,  LOG_NORMAL	},
    { "bits",		do_bits,	POS_DEAD,    L_ANG,  LOG_NORMAL },
    { "echo",		do_echo,	POS_DEAD,    L_ANG,  LOG_ALWAYS	},
    { "fightlist",	do_fightlist,	POS_DEAD,    L_ANG,  LOG_NORMAL },
    { "goto",		do_goto,	POS_DEAD,   L_HERO,  LOG_NORMAL	},
    { "holylight",	do_holylight,	POS_DEAD,    L_ANG,  LOG_NORMAL	},
    { "info",		do_info,	POS_DEAD,    L_GOD,  LOG_NORMAL },
    { "invis",		do_invis,	POS_DEAD,   L_HERO,  LOG_NORMAL	},
    { "karma",		do_karma,	POS_DEAD,    L_DEI,  LOG_ALWAYS },
    ...
    { "send",		do_send,	POS_DEAD,    L_ANG,  LOG_ALWAYS },
    { "slookup",	do_slookup,	POS_DEAD,    L_ANG,  LOG_NORMAL },
    { "switch",		do_switch,	POS_DEAD,    L_ANG,  LOG_ALWAYS	},
    { "voteset",	do_voteset,	POS_DEAD,    L_ANG,  LOG_NORMAL },

    { "immtalk",	do_immtalk,	POS_DEAD,        2,  LOG_NORMAL	},
    { ":",		do_immtalk,	POS_DEAD,    L_ANG,  LOG_NORMAL	},

    /*
     * OLC 1.1b
     */
    { "aedit",		do_aedit,	POS_DEAD,    20,  LOG_NORMAL },
    { "redit",		do_redit,	POS_DEAD,    20,  LOG_NORMAL },
    { "oedit",		do_oedit,	POS_DEAD,    20,  LOG_NORMAL },
    { "medit",		do_medit,	POS_DEAD,    20,  LOG_NORMAL },
    { "asave",          do_asave,	POS_DEAD,    20,  LOG_NORMAL },
    { "alist",		do_alist,	POS_DEAD,    20,  LOG_NORMAL },
    { "resets",		do_resets,	POS_DEAD,    20,  LOG_NORMAL },

    { "bandage",        do_bandage,     POS_FIGHTING,    0,  LOG_NORMAL },
    /*
     * MOBprogram commands.
     */
    { "mpareadam",	do_mpareadam,	POS_DEAD,	41,  LOG_NORMAL },
    { "mpasound",       do_mpasound,    POS_DEAD,       41,  LOG_NORMAL },
    { "mpjunk",         do_mpjunk,      POS_DEAD,       41,  LOG_NORMAL },
    { "mpdamage",	do_mpdamage,	POS_DEAD,	41,  LOG_NORMAL },
    { "mpretarget",	do_mpretarget,	POS_DEAD,	41,  LOG_NORMAL },
    ...
    { "mptransall",	do_mptransall,	POS_DEAD,	41,  LOG_NORMAL },
...
/* this has been removed for new table
...
const	struct	social_type	social_table [] =
{
	...
	"Slap whom?",
	NULL,
	"You slap $N for $S stupidity.",
	"$n slaps $N for $S stupidity.",
	"$n slaps you for your stupidity.  OUCH!",
	"You slap yourself, and find it strangely erotic.",
	"$n slaps $mself, then gets a dreamy smile on $s face."
    },
...
void interpret( CHAR_DATA *ch, char *argument )
{
    ...
    ||   (cmd_table[cmd].log == LOG_PC && !IS_NPC(ch)) )
    {
    ...
    /* is the character tied up? */
    if ( IS_TIED(ch) && cmd_table[cmd].position > POS_RESTING )
    { send_to_char( "You're tied up!\n\r", ch );
      return;
    }
    /* is the character in a mobile suit? */
    if ( IS_SUIT(ch) && cmd_table[cmd].position > POS_RESTING )
    { send_to_char( "You can't do that in a mobile suit.\n\r", ch );
      return;
    }
